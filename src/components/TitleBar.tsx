...
export default function TitleBar() {
  ...
  return (
    <header className="flex h-9 shrink-0 items-center border-b border-zinc-800/60 bg-zinc-950/80">
      ...
      <div className="flex h-full items-stretch">
        <button
          className="flex w-11 items-center justify-center text-zinc-500 transition-colors hover:bg-zinc-800 hover:text-zinc-200"
          onClick={minimize}
          title="最小化"
        >
          <MinimizeIcon />
