    ...
    <section className="rounded-xl border border-zinc-800/60 bg-zinc-900/50 p-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
      ...
      {models.length === 0 ? (
        ...
        <div className="space-y-2">
          <div className="grid grid-cols-[1fr_repeat(3,5.5rem)_4.5rem] items-center gap-2 text-[11px] text-zinc-600">
            <span>模型</span>
            {PRICE_FIELDS.map((f) => (
          ...
          {models.map((m) => {
            ...
            return (
              <div
                key={m.model}
                className="grid grid-cols-[1fr_repeat(3,5.5rem)_4.5rem] items-center gap-2 text-xs"
              >
                <span
